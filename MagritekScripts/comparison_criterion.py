...
for d in random_distortions:
    ...
    if input_args.verbose >= 1:
        ...
        print('Simplex lw50: {} -> {}'.format(linewidth_initial_simplex.item(),linewidth_shimmed_simplex.item()))
    ...
    if input_args.verbose >= 1:
        ...
        print('Nr. function eval.', stepcounter)
        print('DRE+Simplex lw50: {} -> {}'.format(linewidth_initial.item(),linewidth_shimmed_dre_simplex.item()))
